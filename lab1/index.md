#Lab 1 - Introduction to VirtualBox, Unix, and Github
...
**Exercise 1**: Make another directory inside the _unixstuff_ directory called _backups_.
...
**Exercise**: Create a directory called _tempstuff_ using `mkdir`, then remove it using the `rmdir` command.
...
The first thing you need to do is clone the cs240-student github repo into your lab account. To do this, enter:

    git clone https://github.com/cs240/student.git

This will create a 'student' directory, which is the copy of the repo. Each week, you will need to update the repo with the current contents. To do so, cd into that 'student' directory, and enter:
